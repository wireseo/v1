    ...
    <Layout pageTitle="Home Page">
      <div className="space-y-40 p-48">
        <section id="about" className="text-[#FFFFFF] font-light min-w-[600px]">
          ...
          scene in <strong>Singapore's maritime industry.</strong> By day, I
          craft tasteful front-end components and brainstorm ways to optimize
          sprawling backends for multiple products at MarinaChain. By night, I
          am a tinkerer at heart: you can find me writing indie music and making
